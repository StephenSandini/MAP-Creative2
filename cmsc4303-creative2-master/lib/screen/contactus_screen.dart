      ...
      body: Container(
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Padding(
              padding: EdgeInsets.fromLTRB(30.0, 45.0, 30.0, 0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Center(
                    child: Image.network(
                      'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ffiremarshal.utah.gov%2Fwp-content%2Fuploads%2Fsites%2F19%2F2017%2F12%2Ffood-truck.jpg&f=1&nofb=1',
                    ),
                  ),
                  Divider(
                    height: 30.0,
                  ...
                  Row(
                    children: [
                      Icon(Icons.email),
                      SizedBox(width: 40.0, height: 60.0),
                      Text(
                        'AU-somefoodtruck@gmail.com',
